...
@Component
public class It_has_a_maximum_population_of_Y extends EntityInstructionMatcher {
    public It_has_a_maximum_population_of_Y() {
        super("It has a _maximum population_ of _([^_]+)_");
    }
    ...
    public void interpretMatch(MatchResult match, Instruction instruction, Context context) {
        ...
        assertThat(it).at("maxPopulation").asNumber().isEqualTo(expected);
    }
}
