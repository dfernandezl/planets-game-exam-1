...
@Component
public class Type_X_into_its_new_satellite_name extends EntityInstructionMatcher {
    public Type_X_into_its_new_satellite_name() {
        super("Type _([^_]+)_ into its _new satellite name_");
    }
