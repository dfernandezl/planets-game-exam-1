...
@Component
public class It_has_a_fuel_of_Y extends EntityInstructionMatcher {
    public It_has_a_fuel_of_Y() {
        super("It has a _fuel_ of _([^_]+)_");
    }
    ...
    public void interpretMatch(MatchResult match, Instruction instruction, Context context) {
        ...
        assertThat(it).at("fuel").asNumber().isEqualTo(expected);
    }
}
