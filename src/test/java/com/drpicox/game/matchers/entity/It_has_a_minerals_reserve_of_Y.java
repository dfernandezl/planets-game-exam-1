...
@Component
public class It_has_a_minerals_reserve_of_Y extends EntityInstructionMatcher {
    public It_has_a_minerals_reserve_of_Y() {
        super("It has a _minerals reserve_ of _([^_]+)_");
    }
    ...
    public void interpretMatch(MatchResult match, Instruction instruction, Context context) {
        ...
        assertThat(it).at("mineralsReserve").asNumber().isEqualTo(expected);
    }
}
