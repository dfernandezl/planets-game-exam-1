...
@Component
public class It_has_a_minerals_availability_of_Y extends EntityInstructionMatcher {
    public It_has_a_minerals_availability_of_Y() {
        super("It has a _minerals availability_ of _([^_]+)_");
    }
    ...
    public void interpretMatch(MatchResult match, Instruction instruction, Context context) {
        ...
        assertThat(it).at("minerals").asNumber().isEqualTo(expected);
    }
}
