...
@Component
public class It_has_a_population_boost_of_Y extends EntityInstructionMatcher {
    public It_has_a_population_boost_of_Y() {
        super("It has a _population boost_ of _([^_]+)_");
    }
    ...
    public void interpretMatch(MatchResult match, Instruction instruction, Context context) {
        ...
        assertThat(it).at("populationBoost").asNumber().isEqualTo(expected);
    }
}
