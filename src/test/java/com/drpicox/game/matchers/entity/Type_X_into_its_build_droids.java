...
@Component
public class Type_X_into_its_build_droids extends EntityInstructionMatcher {
    public Type_X_into_its_build_droids() {
        super("Type _([^_]+)_ into its _build droids_");
    }
